...
<head>
    <title><decorator:title default="Dating Server"/></title>
    ...
    <!-- / demo -->
    <link href='${contextPath}/assets/stylesheets/dating_server.css' media='all' rel='stylesheet' type='text/css' />
	...
	<script src='${contextPath}/assets/javascripts/javawork/dating_server.js' type='text/javascript'></script>
        ...
        <div class='navbar-inner'>
            <div class='container-fluid'>
                <a class='brand' href='${contextPath}'>
                    ...
                    <span class='hidden-phone'>Dating Server</span>
                </a>
                ...
                <ul class='nav pull-right'>
                    ...
                    <li class='dropdown medium user-menu'>
                        ...
                        <ul class='dropdown-menu'>
                            ...
                            <li class='divider'></li>
                            <li>
                                <a href='${contextPath}/sec/sign_out.ds'>
...
<div id='wrapper'>
	...
	<nav class='' id='main-nav'>
		<div class='navigation'>
			...
			<li class=''>
			    <a href='${contextPath}/u/jobs/1/list.ds'>
			        <i class=' icon-search'></i>
			        <span>Search Jobs</span>
			    </a>
			</li>
			<li class=''>
			    <a href='${contextPath}/u/post_job.ds'>
			        <i class=' icon-upload'></i>
			        <span>Post a Job</span>
			    </a>
			</li>
			<li class=''>
			    <a href='${contextPath}/u/skills/list.ds'>
			...
			<li>
			    ...
			    <ul class='nav nav-stacked' style='display:none'>
			        <li>
			            <a href='${contextPath}/u/dashboard.ds'>
			                <i class=' icon-dashboard'></i>
			                <span>Overview</span>
			            </a>
			        </li>
			        <li class=''>
			            <a href='${contextPath}/u/job/history.ds'>
			        ...
			        <li>
			            <a href='${contextPath}/u/skills.ds'>
			                <i class=' icon-ok'></i>
			                <span>My Skills</span>
			            </a>
			        </li>
