...
<html>
<head>
    <title>Sign-in Dating Server</title>
...
<div id='wrapper'>
    ...
    <div class='controls'>
        ...
        <div class='form-wrapper'>
            ...
            <form:form accept-charset="UTF-8" action="${contextPath}/sec/security_check.ds" method="post" commandName="userSignInForm">
    ...
    <div class='login-action text-center'>
        <a href="${contextPath}/sec/sign_up.ds"><i class='icon-user'></i>
            New to Dating Server?
