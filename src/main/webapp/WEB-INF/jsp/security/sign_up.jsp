...
<div id='wrapper'>
    ...
    <div class='controls'>
        ...
        <div class='form-wrapper'>
            ...
            <form:form accept-charset="UTF-8" action="${contextPath}/sec/sign_up.ds" method="post" commandName = "userSignUpForm"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
            ...
            <div class='text-center'>
                <hr class='hr-normal' />
                <a href="${contextPath}/sec/sign_in.ds"><i class='icon-chevron-left'></i>
                    Go back to sign in
                </a>
            </div>
        </div>
